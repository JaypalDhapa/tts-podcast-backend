...
import { providerKeyRouter } from "./routes/providerKey.routes";
...
export function createApp() {
  ...
  app.use("/api/versions", requireAuth, versionRouter);
  ...
  app.use("/api/provider-keys", requireAuth, providerKeyRouter);
